...
{
    /**
     * @var int[] Array containing `sec` and `usec` views of a timestamp
     */
    private $fixedTime;
     ...
     *
     * @param int[] Array containing `sec` and `usec` views of a timestamp
     * @throws \InvalidArgumentException if the `$timestamp` does not contain `sec` or `usec` views
     */
     ...
     *
     * @return int[] Array containing `sec` and `usec` views of a timestamp
     */
